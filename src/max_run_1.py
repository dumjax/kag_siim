...
config = {
    ...
    ### Model parameters
    'MODEL_CLS': TimmModel,
    'PRETRAINED_MODEL': 'mixnet_xl',  # Don't forget to update the training data path with correct resolution
    'FINETUNING': True,
    'USE_GENDER': True,
    'USE_AGE': True,
    'USE_SITES': True,
    ...
    'OPTIMIZER_KWARGS': {'lr': 2e-5},  # all arguments passed to optimizer, except model parameters
